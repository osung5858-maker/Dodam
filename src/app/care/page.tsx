  ...
  return (
    <div className="min-h-[100dvh] bg-[#FFF9F5]">
      ...
      <div className="max-w-lg mx-auto w-full px-5 pt-4 pb-28 space-y-3">
        {/* 수면 도우미 */}
        <p className="text-[13px] font-semibold text-[#6B6966] mb-1">수면 도우미</p>
        <div className="bg-white rounded-xl border border-[#E8E4DF] overflow-hidden">
          {[
            ...
            <Link
              key={item.title}
              href={item.href}
              className={`flex items-center gap-3 px-4 py-3 active:bg-[#FFF9F5] ${i > 0 ? 'border-t border-[#E8E4DF]' : ''}`}
            >
        ...
        {/* 건강 */}
        <p className="text-[13px] font-semibold text-[#6B6966] mb-1 pt-1">건강</p>
        <div className="bg-white rounded-xl border border-[#E8E4DF] overflow-hidden">
          <Link href="/memory" className="flex items-center gap-3 px-4 py-3 active:bg-[#FFF9F5]">
            <div className="w-9 h-9 rounded-xl bg-[#FFF9F5] flex items-center justify-center shrink-0">
